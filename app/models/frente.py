...
class Frente(Base):
    ...
    usuario          = relationship(
        "Usuario",
        back_populates="frentes",
        foreign_keys=[usuario_id],
    )
    usuarios_activos = relationship(
        "Usuario",
        back_populates="frente_actual",
        foreign_keys="Usuario.frente_actual_id",
    )
    recuerdos        = relationship(
        "Recuerdo",
        back_populates="frente",
